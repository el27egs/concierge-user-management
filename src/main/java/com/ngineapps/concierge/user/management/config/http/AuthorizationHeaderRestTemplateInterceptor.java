 ...
 */
package com.ngineapps.concierge.user.management.config.http;
...
@Slf4j
public class AuthorizationHeaderRestTemplateInterceptor implements ClientHttpRequestInterceptor {
  @Override
  public ClientHttpResponse intercept(
    ...
    log.info("Adding Authorization header: " + tokenValue.substring(0, 15) + "...");
